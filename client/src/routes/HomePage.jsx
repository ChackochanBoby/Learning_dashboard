    ...
    <main className="mx-auto xl:container p-4 w-screen">
      ...
      <section className="p-4 my-12" id="enrolled-courses">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5">
            {
              enrolledCourses?(enrolledCourses.map((course)=><CourseCard title={course.title} imageSrc={course.image} instructor={course.instructor} key={course.id}/>)):<span>there are no managed courses</span>
            }
          </div>
        </section>
